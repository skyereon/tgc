...
@section('hearthstone')
            ...
            <div class="main-container">
                <div class="sec-container">
                    <div class="article">
                        ...
                        {{--<p class="right-align-element"><a class=" btn btn-default" href="/csgo/roomviewcreator/{delete?}" role="button">Расформировать</a></p>--}}
                    </div>
                ...
                <div class="sec-container">
                    ...
                    <div class="article">
                        <h3>Меню управления комнатой:</h3>
                        <p class="right-align-element">
                            <button id="create" type="button" class="btn btn-danger">Не полный</button>
                            <a class=" btn btn-default" href="/csgo/roomviewcreator/delete/{{$id}}" role="button">Расформировать</a>
                        </p>
                    </div>
                    <div class="sec-container-text">
                        <div class="row">
    ...
    <script type="text/javascript">
        ...
        function init()
        {
            var list = '{!!  Server::getListFreePlayers($id) !!}';
            var temp = 1;
            var str='';
            while (temp <= rows){
